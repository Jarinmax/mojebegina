...
- Produkty: 3 polévky (z DB), 4 alkoholické koktejly z begina.cz (Svařák
  Deluxe a Lady Carneval s kompletními texty, Granátový Bond bez úvodního
  popisu a předností, Kosmopolitan zatím jen název, cena a fotka).
...
2. **Produkty ostatních kategorií** — bylinné sirupy, čaje, ovocné
   ...
   **Koktejly:** ceny balení potvrzené cenou za nápoj na webu (3 l =
   15 nápojů). U Granátového Bonda chybí úvodní popis a přednosti (horní
   část stránky), u Kosmopolitanu vše kromě ceny a fotky.
